...
TARGET_SOC=rv1126b
TARGET_ARCH=aarch64
BUILD_DEMO_NAME=yolo26
export GCC_COMPILER=/home/talowe/rv1126b/rv1126b_linux6.1_sdk_v1.1.0/buildroot/output/rockchip_rv1126b/host/bin/aarch64-buildroot-linux-gnu
echo "$GCC_COMPILER"
...
TARGET_SDK="rknn_${BUILD_DEMO_NAME}_cam"
